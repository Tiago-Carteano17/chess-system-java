...
public class ChessMatch {
	...
	private boolean testCheck(Color color) {
		Position kingPsition = king(color).getChessPosition().toPosition();
		...
		for(Piece p : opponentPiece) {
			...
			if(mat[kingPsition.getRow()][kingPsition.getColumn()]) {
				return true;
			}
		}
		return false;
